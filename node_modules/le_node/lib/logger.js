...
var Logger = function (_Writable) {
  ...
  function Logger(opts) {
    ...
    _this.on('buffer drain', function () {
  ...
  (0, _createClass3.default)(Logger, [{
    ...
    value: function log(lvl, _log) {
      ...
      if (modifiedLevel || modifiedLevel === 0) {
        ...
        if (!modifiedLevel && modifiedLevel !== 0) {
          this.emit('error', new _error.LogentriesError(_text2.default.unknownLevel(modifiedLevel)));
          return;
        }
      ...
      this.connection = new _promise2.default(function (resolve) {
        ...
        _this4.reconnection.on('connect', function (connection) {
          ...
          connection.on('timeout', function () {
            _this4.debugLogger.log('Socket was inactive for ' + _this4.inactivityTimeout / 1000 + ' seconds. Destroying.');
            _this4.closeConnection();
            _this4.connection = null;
            _this4.emit('timed out');
          });
          resolve(connection);
        });
    ...
    set: function set(val) {
      ...
      var _toLevel4 = (0, _slicedToArray3.default)(_toLevel3, 1);
      ...
      var LogentriesTransport = function (_Transport) {
        ...
        (0, _createClass3.default)(LogentriesTransport, [{
          ...
          get: function get() {
            ...
            var _logger$toLevel2 = (0, _slicedToArray3.default)(_logger$toLevel, 2);

            var lvlName = _logger$toLevel2[1];
    ...
    value: function bunyanStream(opts) {
      ...
      var _stream$logger$toLeve2 = (0, _slicedToArray3.default)(_stream$logger$toLeve, 2);

      var level = _stream$logger$toLeve2[1];
